...
sre.SystemExternal.fs=sre.SystemExternal.documentSupported()?null:sre.SystemExternal.require("fs");sre.SystemExternal.xm=sre.SystemExternal.documentSupported()?null:sre.SystemExternal.require("xml-mapping");sre.SystemExternal.locationSupported=function(){return"undefined"!=typeof location};sre.SystemExternal.url=sre.SystemExternal.locationSupported()?location.protocol+"//progressiveaccess.com/content":"https://progressiveaccess.com/content";
...
sre.Debugger.prototype.output_=function(a){this.outputFunction_.apply(console.log===this.outputFunction_?console:this.outputFunction_,["Speech Rule Engine Debugger:"].concat(a))};sre.Debugger.prototype.output=function(a){this.isActive_&&this.output_(Array.prototype.slice.call(arguments,0))};sre.Debugger.prototype.generateOutput=function(a){this.isActive_&&this.output_(a.apply(a,[]))};sre.Debugger.prototype.exit=function(a){this.isActive_&&this.stream_&&this.stream_.end("","",a||function(){})};sre.EnrichCase=function(){};sre.EnrichCase.prototype.getMathml=function(){};sre.AbstractEnrichCase=function(a){this.semantic=a};sre.AbstractEnrichCase.prototype.getMathml=goog.abstractMethod;sre.AbstractEnrichCase.test=goog.abstractMethod;sre.EnrichCaseFactory=function(){};sre.EnrichCaseFactory.getEmbellishedCase=function(a){return new sre.EnrichCaseFactory.embellishedCase(a)};sre.EnrichCaseFactory.cases=[];sre.EnrichCaseFactory.getCase=function(a){for(var b=0,c;c=sre.EnrichCaseFactory.cases[b];b++)if(c.test(a))return new c.constr(a);return null};sre.SemanticUtil=function(){};sre.SemanticUtil.objectsToKeys=function(a){a=Array.prototype.slice.call(arguments,0);var b=[];return b.concat.apply(b,a.map(Object.keys))};sre.SemanticUtil.objectsToValues=function(a){a=Array.prototype.slice.call(arguments,0);var b=[];a.forEach(function(a){for(var c in a)b.push(a[c])});return b};
...
sre.Cli.prototype.commandLine=function(){var a=sre.SystemExternal.commander,b=sre.System.getInstance(),c=sre.System.getInstance().fileToSpeech;a.dom="";a.enumerate=!1;a.input="";a.locale="";a.log="";a.output="";a.semantics=!1;a.style="";a.verbose=!1;a.audit=!1;a.mathml=!1;a.generate=sre.Engine.Speech.NONE;a.json=!1;a.speech=!1;a.markup="";a.xml=!1;a.version(b.version).option("").option("-i, --input [name]","Input file [name].").option("-o, --output [name]","Output file [name]. Defaults to stdout.").option("").option("-d, --dom [name]","Domain or subject area [name].").option("-t, --style [name]",
"Speech style [name].").option("-c, --locale [code]","Locale [code].").option("-s, --semantics","Switch OFF semantics interpretation.").option("-e, --enumerate","Enumerates available domains and styles.").option("").option("-a, --audit","Generate auditory descriptions (JSON format).").option("-j, --json","Generate JSON of semantic tree.").option("-m, --mathml","Generate enriched MathML.").option("-g, --generate [depth]","Include generated speech in enriched MathML (currently only makes sense with -m option).").option("-p, --speech",
"Generate speech output (default).").option("-k, --markup [name]","Generate speech output with markup tags.").option("-x, --xml","Generate XML of semantic tree.").option("").option("-v, --verbose","Verbose mode.").option("-l, --log [name]","Log file [name].").parse(sre.SystemExternal.process.argv);try{if(a.enumerate){b.setupEngine({mode:sre.Engine.Mode.SYNC});var d=sre.Engine.getInstance().getAxisValues(),e="",f;for(f in d)e+=f.charAt(0).toUpperCase()+f.slice(1)+" options: "+d[f].slice().sort().join(", ")+
"\n";console.log(e);sre.SystemExternal.process.exit(0)}b.setupEngine({semantics:!a.semantics,domain:a.dom,locale:a.locale,style:a.style,mode:sre.Engine.Mode.SYNC,speech:a.generate,markup:a.markup});a.verbose&&sre.Debugger.getInstance().init(a.log);a.input&&(a.audit&&(c=b.fileToDescription),a.json&&(c=b.fileToJson),a.mathml&&(c=b.fileToEnriched),a.speech&&(c=b.fileToSpeech),a.xml&&(c=b.fileToSemantic),c(a.input,a.output))}catch(g){console.log(g.name+": "+g.message),sre.Debugger.getInstance().exit(function(){sre.SystemExternal.process.exit(1)})}sre.Debugger.getInstance().exit(function(){sre.SystemExternal.process.exit(0)})};
process.env.SRE_TOP_PATH&&(new sre.Cli).commandLine();
